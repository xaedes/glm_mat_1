...
namespace glm
{
	...
	public:
		...
		GLM_FUNC_DECL GLM_CONSTEXPR mat(mat<3, 1, T, P> const& m);
		...
		GLM_FUNC_DECL GLM_EXPLICIT GLM_CONSTEXPR mat(mat<3, 1, U, P> const& m);
		...
		template<typename U>
		GLM_FUNC_DECL mat<3, 1, T, Q> & operator=(mat<3, 1, U, Q> const& m);
		template<typename U>
		GLM_FUNC_DECL mat<3, 1, T, Q> & operator+=(U s);
		template<typename U>
		GLM_FUNC_DECL mat<3, 1, T, Q> & operator+=(mat<3, 1, U, Q> const& m);
		template<typename U>
		GLM_FUNC_DECL mat<3, 1, T, Q> & operator-=(U s);
		...
		GLM_FUNC_DECL mat<3, 1, T, Q> & operator++ ();
		GLM_FUNC_DECL mat<3, 1, T, Q> & operator-- ();
		GLM_FUNC_DECL mat<3, 1, T, Q> operator++(int);
		GLM_FUNC_DECL mat<3, 1, T, Q> operator--(int);
	};
	...
	template<typename T, qualifier Q>
	GLM_FUNC_DECL mat<3, 1, T, Q> operator+(mat<3, 1, T, Q> const& m);
	...
	template<typename T, qualifier Q>
	GLM_FUNC_DECL mat<3, 1, T, Q> operator+(mat<3, 1, T, Q> const& m, T scalar);

	template<typename T, qualifier Q>
	GLM_FUNC_DECL mat<3, 1, T, Q> operator+(mat<3, 1, T, Q> const& m1, mat<3, 1, T, Q> const& m2);

	template<typename T, qualifier Q>
	GLM_FUNC_DECL mat<4,1, T, Q> operator-(mat<4,1, T, Q> const& m, T scalar);

	template<typename T, qualifier Q>
	GLM_FUNC_DECL mat<4,1, T, Q> operator-(mat<4,1, T, Q> const& m1, mat<3, 1, T, Q> const& m2);

	template<typename T, qualifier Q>
	GLM_FUNC_DECL mat<4,1, T, Q> operator*(mat<4,1, T, Q> const& m, T scalar);

	template<typename T, qualifier Q>
	GLM_FUNC_DECL mat<3, 1, T, Q> operator*(T scalar, mat<3, 1, T, Q> const& m);

	template<typename T, qualifier Q>
	GLM_FUNC_DECL typename mat<3, 1, T, Q>::col_type operator*(mat<3, 1, T, Q> const& m, typename mat<3, 1, T, Q>::row_type const& v);

	template<typename T, qualifier Q>
	GLM_FUNC_DECL typename mat<3, 1, T, Q>::row_type operator*(typename mat<3, 1, T, Q>::col_type const& v, mat<3, 1, T, Q> const& m);

	template<typename T, qualifier Q>
	GLM_FUNC_DECL mat<1, 1, T, Q> operator*(mat<3, 1, T, Q> const& m1, mat<1, 3, T, Q> const& m2);

	template<typename T, qualifier Q>
	GLM_FUNC_DECL mat<2, 1, T, Q> operator*(mat<3, 1, T, Q> const& m1, mat<2, 3, T, Q> const& m2); // new

	template<typename T, qualifier Q>
	GLM_FUNC_DECL mat<3, 1, T, Q> operator*(mat<3, 1, T, Q> const& m1, mat<3, 3, T, Q> const& m2);

	template<typename T, qualifier Q>
	GLM_FUNC_DECL mat<4, 1, T, Q> operator*(mat<3, 1, T, Q> const& m1, mat<4, 3, T, Q> const& m2);
	...
	template<typename T, qualifier Q>
	GLM_FUNC_DECL bool operator==(mat<3, 1, T, Q> const& m1, mat<3, 1, T, Q> const& m2);
